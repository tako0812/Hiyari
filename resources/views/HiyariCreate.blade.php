                        ...
                        <form action="{{ route('hiyari.post') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="work_id" required>
                                    ...
                                    @foreach ($work_id as $work)
                                        <option value="{{ $work->work_id }}" @if(old('work_id')==$work->work_id) selected  @endif>{{ $work->work_id }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="train_id"  required>
                                    ...
                                    @foreach ($train_id as $train)
                                        <option value="{{ $train->train_id }}" @if(old('train_id')==$train->train_id) selected  @endif>{{ $train->train_id }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="age_id" required>
                                    ...
                                    <option value="{{ $age->id }}" @if(old('age_id')==$age->id) selected  @endif>{{ $age->age_name }}
                                    </option>
                                @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="operation_id" required>
                                    ...
                                    <option value="{{ $operation->id }}" @if(old('operation_id')==$operation->id) selected  @endif>{{ $operation->operation_name }}
                                    </option>
                                @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>発生場所</label>
                                <input class="form-control" type="text" name="place" required value="{{ old('place') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="10" type="text" name="text" required>{{old('text')}}</textarea>
                            </div>
                            <div class="form-group">
